...
import { PagamentoDetailsDialog } from "./PagamentoDetailsDialog";
...
export const PagamentosTable = ({
  ...
  const handleOpenDialog = (pagamento: any) => {
              ...
              {pagamentosFiltrados.map((p) => (
                <tr key={p.id}>
                  ...
                  <td className="px-4 py-3">
                    <Button
                      size="sm"
                      className="cursor-pointer px-2 py-1 text-[#F8FAFC] hover:bg-[#23262F]"
