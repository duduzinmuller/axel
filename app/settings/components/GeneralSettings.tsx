    ...
    >
      <div className="space-y-4">
        <FormField label="Nome do Assistente">
          <input
            type="text"
            className="w-full rounded-lg border border-[#3B82F6] bg-transparent px-3 py-2 text-sm text-white placeholder:text-neutral-500 focus:ring-2 focus:ring-blue-600 focus:outline-none"
            placeholder="AXEL"
          />
        </FormField>
        <FormField label="Idioma Principal">
          <select className="w-full rounded-lg border border-[#3B82F6] bg-transparent px-3 py-2 text-sm text-white">
